...
def rotate_image(inner_image, outer_image, similar_precision, rotate_type):
    ...
    try:
        ...
        print('rotate_image error :: ' + str(e))
        return False


def image_to_cv2(base_image, image_type, color_type, proxies=None):
    try:
...
def rotate_detect(small_circle, big_circle, image_type: int = 0, color_type: bool = True, check_pixel: int = 10,
    ...
    try:
        ...
        print('rotate_detect error! :: ' + str(e))
        return False


def rotate_detect_and_show_image(
